...
class G_R_Get_Results_301_UI:
    def __init__(self, logic_connection, match):
        self.logic_wrapper = logic_connection
        self.match = match

    def input_results_301(self):
        ...
        AP3 = ""
        AP4 = ""
        d301 = Game(id,game_type,score,HP1,HP2,HP3,HP4,AP1,AP2,AP3,AP4)
        self.logic_wrapper.create_game(d301)
        return d301
